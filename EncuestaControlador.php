...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	<label>RUTA: </label> <select class="form-control" id="canal"
		...
		ruta es el indicado? </label> <select class="form-control" id="tienda"
		name="tienda" required>
		<option selected value="">Elige una opción</option>
		<option value="SI">Si</option>
		<option value="NO">No</option>
		...
		programados que hacen cambiar la velocidad en la operación? </label> <select
		class="form-control" id="tienda" name="tienda" required>
		<option selected value="">Elige una opción</option>
		<option value="SI">Si</option>
		<option value="NO">No</option>
	</select> <br /> <br /> <label>¿Recibe usted quejas de los usuarios en
		el punto de inicio del servicio? </label> <select class="form-control"
		id="tienda" name="tienda" required>
		<option selected value="">Elige una opción</option>
		<option value="SI">Si</option>
		<option value="NO">No</option>
