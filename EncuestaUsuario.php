...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	...
	</select> <br /> <br /> <label>Seleccione los dÃ­as que usa el servicio
		de la ruta indicada: </label> <select class="form-control" id="canal"
		name="canal" autofocus required> Lunes
	...
	<select class="form-control" id="tienda" name="tienda" required>
		...
		<option value="NO">No</option>
		<option value="No sabe">No sabe</option>
	</select> <br> <input type="submit" name="submit" value="Enviar"> <br>
	<br>
</form>
<?php
