...
<div id="welcome">	
    ...
    <img src="imagenes/CONTROLADOR.jpg"  style="max-width:10%;width:30;height:30;">
...
<br /> 
<br /> 	
	    <label >¿El tiempo de recorrido en general asignado para la ruta es el adecuado? </label>
...
<br /> 
<br /> 
 <label >¿El intervalo según la ocupación de la ruta es el indicado? </label>
<select class="form-control" id="tienda"  name="tienda"   required>
	<option selected value=""> Elige una opción </option>
	<option value="SI">Si</option> 
	<option value="NO">No</option> 
...
<br /> 
<br /> 
    <label >¿Los operadores conocen la ruta y atienden todas las paradas?:  </label>
<select class="form-control" id="tienda"  name="tienda"   required>
	<option selected value=""> Elige una opción </option>
...
<br /> 
<br /> 
 <label >¿La ruta tiene saltos en los tiempos no programados que hacen cambiar la velocidad en la operación? </label>
<select class="form-control" id="tienda"  name="tienda"   required>
	<option selected value=""> Elige una opción </option>
	<option value="SI">Si</option> 
	<option value="NO">No</option> 
...
<br /> 
<br /> 
 <label >¿Recibe usted quejas de los usuarios en el punto de inicio del servicio? </label>
<select class="form-control" id="tienda"  name="tienda"   required>
	<option selected value=""> Elige una opción </option>
	<option value="SI">Si</option> 
	<option value="NO">No</option> 
